...
def gen_res_t2(input_folder, guide_folder, Save_dir):
    Remodel1 = DFuseNet()
    Remodel1.cuda().eval()
...
if __name__ == '__main__':
   ...
   # computeComplexity()
    ...
    Save_dir      = 'work_space/Test_Track2_DeepBlueAI'                       ## Result save dir
    input_folder  = "/data/hejy/datasets/NRITE_Relight/Aug/test_t3/input/"    ## Change to input dir of Track2 test dataset 
    guide_folder  = "/data/hejy/datasets/NRITE_Relight/Aug/test_t3/guide/"    ## Change to guide dir of Track2 test dataset 

    gen_res_t2(input_folder, guide_folder, Save_dir)
