...
class SGD_Dist(Optimizer):
    def __init__(self, params, lr=required, momentum=0, dampening=0, weight_decay=0, nesterov=False, rescale=1):
        ...
        super(SGD_Dist, self).__init__(params, defaults)
